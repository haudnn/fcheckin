...
namespace OnetezSoft.Data
{
	public class DbHrmDayOff
	{
		...
		public static List<HrmDayOffModel> GetAll(string companyId)
		{
			var _db = Mongo.DbConnect("fastdo_" + companyId);

			var collection = _db.GetCollection<HrmDayOffModel>(_collection);

			var results = collection.Find(x => !x.isDeleted).ToList();
		...
		public static List<HrmDayOffModel> GetAll(string companyId, bool isAll)
		{
			var _db = Mongo.DbConnect("fastdo_" + companyId);
		...
		public static bool CheckOff(string companyId, DateTime day, string userId)
		{
			var list = GetAll(companyId);
